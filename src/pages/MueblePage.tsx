  ...
  return (
    <>
      <div className="h-fit flex flex-col md:flex-row gap-16 mt-8">
        ...
        {/* <div className=""> Galeria de Imagenes</div> */}
        ...
        <div className="flex-1 space-y-5">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex gap-3">
              {availableColors.map((color) => (
                <button
                  key={color}
                  className={`w-8 h-8 rounded-full flex justify-center cursor-pointer items-center ${
          ...
          <div className="flex flex-col gap-3">
            <p className="text-xs font-medium">Tamaño:</p>
