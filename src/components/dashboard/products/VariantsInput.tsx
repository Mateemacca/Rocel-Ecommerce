...
const headerVariants = ["Stock", "Precio", "Capacidad", "Color", ""];
  ...
  return (
    <div className="flex flex-col gap-3 ">
          ...
          <div key={field.id}>
            <div className="grid grid-cols-5 gap-4 items-center">
              <input
                ...
                className="border border-gray-300 rounded-md px-3 py-1.5 text-xs font-semibold placeholder:font-normal focus:outline-none appearance-none"
              />
              <input
                type="number"
                step="0.01"
              ...
              <div className="flex  relative">
                ...
                <button
                  className="border border-gray-300 text-gray-400  w-full h-8 cursor-pointer rounded text-xs font-medium flex items-center justify-center"
                  type="button"
      ...
      {fields.length === 0 && errors.variants && (
        <p className="text-red-500 text-xs mt-1">
          Tenes que agregar al menos una variante
        </p>
      )}
    </div>
  );
