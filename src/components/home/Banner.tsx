    ...
    <div className="relative bg-gray-900 text-white">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center py-20 px-4 text-center lg:py-40 lg:px-8 ">
        ...
        <p className="text-lg mb-8 lg:text-2xl ">
          Descubri las ofertas exclusivas de nuestra muebleria online.
        </p>
        <Link
          to="/muebles"
          className="bg-gray-900 hover:bg-gray-950 text-white font-semibold py-3 px-6 rounded-lg shadow-xl transition duration-300 ease-in-out"
        >
          Ver Muebles
        </Link>
      </div>
